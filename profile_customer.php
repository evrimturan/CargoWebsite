  ...
  <div class ="w3-row">
    ...
    <div class ="w3-col m10 l11">
      <div style="border-left:1px solid #000;height:1000px;">
        ...
        $i = 2;
        $sql_user_info = "SELECT fName,midName,lastName,country,city,district,street,phone,email FROM customer WHERE userName ='".$_GET["firstname"]."';";
        $sql_get_phone = "SELECT phoneNumber FROM customer_phone WHERE userName='".$_GET["firstname"]."'";
        ...
        <div style="border-top:1px solid #000;height:1000px;">
          ...
          <form action = "update_customer.php?firstname=<?php echo $_GET["firstname"] ?>" method = "post">
            First Name: <input type="text"
            <?php
            require "connectdb.php";
            $sql_name = "SELECT fName from customer WHERE userName='".$_GET["firstname"]."'";
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT midName from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT lastName from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT country from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT city from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            echo "value="."\"".$row["city"]."\"";
             ?>
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT district from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT street from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT phone from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
            ...
            <?php
            require "connectdb.php";
            $sql_name = "SELECT email from customer WHERE userName='".$_GET["firstname"]."'";
            $res = $con->query($sql_name);
            $row = mysqli_fetch_assoc($res);
