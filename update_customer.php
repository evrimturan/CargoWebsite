...
if(mysqli_query($con,$sql_update)){
  header("Location: profile_customer.php?firstname=".$_GET["firstname"]."&complete=true");
}else{
  header("Location: profile_customer.php?firstname=".$_GET["firstname"]."&complete=false");
