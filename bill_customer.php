  ...
  <div class ="w3-row">
    ...
    <div class ="w3-col m10 l11">
      <div style="border-left:1px solid #000;height:800px;">
        <strong><p style="left 15px ;border-top:1px solid #000;">Display my Bill</p></strong>
        <form action = "bill_generate_customer.php?firstname=<?php echo $_GET["firstname"]?>" method = "post">
          Tracking Number: <input type="number" name="ship_no">
          <br>
          <button class = "mystyle2" type="submit">Display</button>
        </form>
      </div>
    </div>
  </div>
