...
<body>
  ...
  <strong><h1>Status Page</h1></strong>
  <hr style="border-top:1px solid #000";></hr>
  <br>
  <div class ="w3-row">
    ...
    <div class ="w3-col m10 l11">
      <div style="border-left:1px solid #000;height:800px;">
        ...
        <form action = "check_stat.php?firstname=<?php echo $_GET["firstname"] ?>" method = "post">
          Tracking Number: <input type="number" step="0.01" name="ship_no">
          <br>
          <button class="mystyle2" type="submit">Check shipment</button>
        </form>
      </div>
    </div>
  </div>
